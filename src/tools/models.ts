...
export const inspireModels = tool({
...
async function handleDetail(params: any) {
  ...
  try {
    ...
    return {
      ...
      metadata: { error: "detail_failed", model_id: params.model_id },
    }
  }
...
async function handleCreate(params: any) {
  ...
  return {
    title: params.name,
    output: lines.join("\n"),
    metadata: { model_id: createdId, workspace_id: ws.id, project_id: proj.id },
  }
}
...
async function handleDelete(params: any) {
  ...
  try {
    ...
    return {
      ...
      metadata: { error: "delete_failed", model_id: params.model_id },
    }
  }
  ...
  return {
    ...
    metadata: { model_id: params.model_id, action: "deleted" },
  }
}
